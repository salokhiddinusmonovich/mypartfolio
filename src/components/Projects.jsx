...
export default function Projects() {
  return (
    <section id="projects" className="p-6 bg-transparent">
      <h2 className="text-3xl font-mono font-bold text-center mb-6 text-green-400">ls projects/</h2>
        ...
        {[1, 2, 3].map((project) => (
          ...
          >
            ...
            <div className="flex gap-2 mt-4">
              ...
              <span className="bg-gray-700 px-2 py-1 rounded text-sm">Tailwind</span>
            </div>
          </motion.div>
        ))}
      </div>
